            ...
            <div class="row">
              <div class="col-lg-6">
                <h1 class="display-3 text-white">
                  THE HOLY TRINITY ENGLISH MEDIUM HSS
                  <!-- <span>completed with examples</span> -->
                </h1>
                <p
                  class="lead text-white"
                >The Holy Trinity, Sreekaryam, The Holy Trinity EMHHS, The Holy Trinity HSS, Alathara School, Sreekryam Holy Trinity</p>
            ...
            <div class="row row-grid">
              <div class="col-lg-3">
                <card class="border-0" hover shadow body-classes="py-5">
                  ...
                  <h6 class="text-primary text-uppercase">Co-curricular Activity</h6>
                  <p
                    class="description mt-3"
                  >Facilitate in the development of various domains of mind and personality including Creativity, Enthusiasm, and Positive thinking.</p>
                  <!-- <div>
              ...
              <div class="col-lg-3">
                <card class="border-0" hover shadow body-classes="py-5">
                  ...
                  <h6 class="text-success text-uppercase">Special Education</h6>
                  <p
                    class="description mt-3"
                  >Practice of educating students in a way that addresses their individual differences and needs.</p>
                  <!-- <div>
              ...
              <div class="col-lg-3">
                <card class="border-0" hover shadow body-classes="py-5">
                  ...
                  <h6 class="text-warning text-uppercase">Book & Library</h6>
                  <p
                    class="description mt-3"
                  >Curated collection of sources of information and similar resources.</p>
                  <!-- <div>
              ...
              <div class="col-lg-3">
                <card class="border-0" hover shadow body-classes="py-5">
                  <icon name="ni ni-planet" type="warning" rounded class="mb-4"></icon>
                  <h6 class="text-warning text-uppercase">Smart Class</h6>
                  <p
                    class="description mt-3"
                  >Teaching and learning become exciting and easy with the smart classes.</p>
                  <!-- <div>
                    <badge type="warning" rounded>marketing</badge>
                    <badge type="warning" rounded>product</badge>
                    <badge type="warning" rounded>launch</badge>
        ...
        <div class="row row-grid align-items-center">
          ...
          <div class="col-md-6 order-md-1">
            <div class="pr-md-5">
              ...
              ></icon>-->
              <h3>What We Offer</h3>
              <p>As you begin to refine your boarding school search, one of the things you will find yourself doing is circling back to find out which schools offer the programs your child wants and needs. Remember: you and your child need to discuss your wants and needs together.</p>
                ...
                <li class="py-2">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <p
                        class="description mt-3"
                      >Protection of students from violence, exposure to weapons and threats, theft, bullying, and the sale or use of illegal substances on school grounds.</p>
                    </div>
                  </div>
                </li>
                <li class="py-2">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <p
                        class="description mt-3"
                      >We still realize the benefits of maintaining regular classroom teaching.</p>
                    </div>
                  </div>
                </li>
                <li class="py-2">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <p
                        class="description mt-3"
                      >All the teachers have credentials from an authoritative source like the government.</p>
                    </div>
                  </div>
                </li>
                <li class="py-2">
                  <div class="d-flex align-items-center">
                    ...
                    <div>
                      ...
                      <p
                        class="description mt-3"
                      >Sports help to build character and teach the importance of discipline in life.</p>
                    </div>
                  </div>
                </li>
              </ul>
